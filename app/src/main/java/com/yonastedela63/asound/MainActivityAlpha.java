...
public class MainActivityAlpha extends AppCompatActivity implements TextToSpeech.OnInitListener, BotomBar.OnColorChangedListener, TopBarSecond.OnLanguageChangedListener, TopBarSecond.OnColorUpdateListener  {

    private TextToSpeech textToSpeech;
    Fragment fragment, fragment2;
    Button wordTxt;

    private ImageButton btnWord,capitalLetter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction2.replace(R.id.alphaFragmentBottom, fragment2);
